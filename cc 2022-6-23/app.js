...
//parameters - takes in certain bills that are strings £5, £2, £1, 50p, 20p
//Return - a string as change in descending order
...
function changeMe(moneyIn){
    switch (moneyIn){
        ...
        case '50p': return change = '20p 20p 10p'
        case '20p':return  change = '10p 10p'
