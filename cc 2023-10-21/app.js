...
//prep
//parameters -  candidate and the job
//return -  a bolean of true if valid match.  Valid match min salary <= job max salary (10% wiggle room) if either parameter missing - error
//example - 
